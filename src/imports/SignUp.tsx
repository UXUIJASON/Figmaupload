import svgPaths from "./svg-k4nzwgh1t7";
...
function Title() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start leading-[1.4] not-italic relative shrink-0 w-full" data-name="title">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold relative shrink-0 text-[#111c2d] text-[21px] tracking-[-0.21px] w-full">Sign Up</p>
...
function SignUpLink() {
  return (
    <div className="content-stretch flex gap-[8px] items-center leading-[1.4] not-italic relative shrink-0 text-[14px] text-nowrap w-full" data-name="sign up link">
      <p className="font-['Inter:Regular',sans-serif] font-normal relative shrink-0 text-[#111c2d]">Already have an Account?</p>
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold relative shrink-0 text-[#00a1ff] tracking-[-0.14px]">Sign In</p>
    </div>
  );
}
